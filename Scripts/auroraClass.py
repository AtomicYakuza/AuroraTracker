...
class Aurora:
    ...
    totalSteps = 2 #total number of steps in the loading process
    ...
    def request(self):
        ...
        try:
            ...
            print(f"An error occurred: {e}") #print the error for debug --most likely an issue with the requesting of data eg: server down
    ...
    def cleanData(self, data):
        ...
        self.progressBar(True, "analysing data (2/" + str(self.totalSteps) + ")", 0.05) #call progress bar
    ...
    def dataAnalysis(self, data, time, date):
        ...
        kpValueThreshold = 7 #should be 7 for coventry
